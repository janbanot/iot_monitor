...
export const mapThingSpeakToParameterData = (entry: ThingSpeakEntry): ParameterData[] => {
  ...
  return [
    {
      ...
      unit: '°C',
      icon: 'Thermometer',
      status: tempAlert ? 'critical' : (temperature > 23 || temperature < 20) ? 'warning' : 'normal',
      lastUpdated,
      ranges: {
...
export const mapChannelToStationInfo = (channel: any, lastSync: Date): StationInfo => {
  return {
