...
const ParameterCard: React.FC<ParameterCardProps> = ({ parameter }) => {
  ...
  return (
    <div className={`bg-white rounded-lg shadow-md border-l-4 ${getCardBorderColor()} p-6 hover:shadow-lg transition-shadow duration-200`}>
      ...
      <div className="space-y-2">
        <div className="flex justify-between text-sm">
          ...
          <span className="text-gray-700">
            {parameter.ranges.normal.min} - {parameter.ranges.normal.max} {parameter.unit}
          </span>
        </div>
        <div className="flex justify-between text-sm">
